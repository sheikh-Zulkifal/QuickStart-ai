...
export default function Partners() {
  return (
    <section id="partners" className="max-w-screen-md w-full mx-auto px-4 py-24 gap-12 md:px-8 flex flex-col justify-center items-center">
      <motion.h2
        ...
        className="text-2xl tracking-tighter sm:text-3xl to-foreground/70 bg-gradient-to-t from-blue-500  text-transparent bg-clip-text border-none text-pretty text-center"
      >
        Our Partners
      </motion.h2>
